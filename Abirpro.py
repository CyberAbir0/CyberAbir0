# Decompile by Mardis (Tools By Abir )
...
logo = ("""
 ...
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   :.         Abir Khan  \033[1;32m║
...
def riddu():
    ...
    print(" \033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××")              
    code = input(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Choose : ')
    os.system('clear')
    print(logo)
    ...
    for bilal in range(passx):
        pww = input(f"\033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Enter Password {Abir} : ")
        HamiiID.append(pww)
    with ThreadPool(max_workers=30) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m Abir Khan ')
